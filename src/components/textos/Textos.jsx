export const textos = [
  {
    name: "manifiesto",
    texto: `
    **En los reinos donde la llama de la vida arde,
    El potencial ilimitado de la humanidad se expande.
    A través del vigor del alma, nos elevamos,
    ...
    Donde las mentes diversas armoniosamente creamos.\n
    ...
    Un futuro donde cada ser puede ser.\n
